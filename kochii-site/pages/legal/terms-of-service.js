    ...
    <main class="mt-5">
      <div class="container">
        ...
        <p>
          ...
          use of Kochii's Website.
        </p>{" "}
        <br />
        <span style={{ textTransform: "capitalize" }}> Kochii</span> is located
        at:
        <br />
        <address>
        ...
        <p>
          ...
          conditions in full. Do not continue to use Kochii's website if you do
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using Kochii's website you consent to
          the use of cookies in accordance with Kochii's privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, Kochii and/or it's licensors own the
          intellectual property rights for all material on Kochii. All
          intellectual property rights are reserved. You may view and/or print
          pages from https://kochii.app for your own personal use subject to
        ...
        <p>
          Redistribute content from Kochii (unless content is specifically made
          for redistribution).
        </p>
        ...
        <p>
          ...
          outweighs the absence of Kochii; and (d) where the link is in the
        ...
        <p>
          ...
          e-mail to{" "}
          <a
            href="mailto:contact@kochii.app"
            title="send an email to contact@kochii.app"
          >
            contact@kochii.app
          </a>
        ...
        <p>
          No use of Kochii's logo or other artwork will be allowed for linking
